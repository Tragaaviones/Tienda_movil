...
import CarritoCard from '../components/CarritoCard/Carrito';
import Modal_cantidad from '../components/modals/modal_cantidad';
...
const Carrito = ({ navigation }) => {
    ...
    const getDetalleCarrito = async () => {
        try {
            const response = await fetch(`${ip}/tienda/api/servicios/publico/pedido.php?action=readDetail`, {
                method: 'GET',
            });
    ...
    const finalizarPedido = async () => {
        try {
            const response = await fetch(`${ip}/tienda/api/servicios/publico/pedido.php?action=finishOrder`, {
                method: 'GET',
            });
            const data = await response.json();
            if (data.status) {
